...
function mm_simwa_get_wa_button() {
	...
	if ( $mm_simwa_wa_number ) {
		?>
	<li><a href="<?php echo esc_html( $wa_url ); ?>" class="wa-btn simwa-wa-btn" rel="noopener nofollow" title="chat whatsapp" style="background-color:<?php echo esc_html( $bgcol ); ?>; color:<?php echo esc_html( $text_color ); ?>; fill:<?php echo esc_html( $icon_color ); ?>;"><?php echo wp_kses( mm_simwa_get_data()['wa_btn_text'], $pass ); ?></a></li>
		<?php
	}
}